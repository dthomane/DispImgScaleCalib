...
We have prepared calibration and evaluation scripts for the OSDaR23 Dataset. You can download the preprocessed depth and segmentation data from here (link follows soon).
